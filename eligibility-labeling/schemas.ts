...
export const PROSTATE_SCHEMA = {
  ...
  fields: {
    ...
    msiStatus: { kind: 'categorical', values: ['MSI_HIGH', 'MSS'] },
...
export const LUNG_SCHEMA = {
  ...
  fields: {
    ...
    krasStatus: { kind: 'categorical', values: ['G12C', 'NON_G12C', 'WILD_TYPE'] },
    brafStatus: { kind: 'categorical', values: ['V600E', 'NON_V600E', 'WILD_TYPE'] },
    ...
    her2Status: { kind: 'categorical', values: ['MUTATED', 'AMPLIFIED', 'WILD_TYPE'] },
...
export const COLORECTAL_SCHEMA = {
  ...
  fields: {
    ...
    measurableDiseaseRecist: { kind: 'boolean' },
    rasStatus: { kind: 'categorical', values: ['KRAS_MUTATED', 'NRAS_MUTATED', 'WILD_TYPE'] },
    krasG12cStatus: { kind: 'categorical', values: ['MUTATED', 'WILD_TYPE'] },
    brafStatus: { kind: 'categorical', values: ['V600E', 'NON_V600E', 'WILD_TYPE'] },
    msiStatus: { kind: 'categorical', values: ['MSI_HIGH_DMMR', 'MSS_PMMR'] },
    her2Status: { kind: 'categorical', values: ['AMPLIFIED', 'OVEREXPRESSED', 'NEGATIVE'] },
...
export const MELANOMA_SCHEMA = {
  ...
  fields: {
    ...
    brafStatus: { kind: 'categorical', values: ['V600E', 'V600K', 'NON_V600', 'WILD_TYPE'] },
...
export const BILIARY_SCHEMA = {
  ...
  fields: {
    ...
    idh1Status: { kind: 'categorical', values: ['MUTANT', 'WILD_TYPE'] },
    her2Status: { kind: 'categorical', values: ['POSITIVE', 'NEGATIVE'] },
    brafStatus: { kind: 'categorical', values: ['V600E', 'WILD_TYPE'] },
    krasStatus: { kind: 'categorical', values: ['G12C', 'OTHER_KRAS', 'WILD_TYPE'] },
    msiStatus: { kind: 'categorical', values: ['MSI_HIGH_DMMR', 'MSS_PMMR'] },
    measurableDiseaseRecist: { kind: 'boolean' },
...
export const MYELOID_SCHEMA = {
  ...
  fields: {
    ...
    idh1Mutated: { kind: 'boolean' },
    idh2Mutated: { kind: 'boolean' },
